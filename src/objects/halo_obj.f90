...
module subroutine setup_batch_exch(this, exch_vars, adv_vars, comms)
    ...
    if (.not.(comms == MPI_COMM_NULL)) then
            ...
            call MPI_WIN_ALLOCATE(win_size*sizeof(realnum), sizeof(realnum), info_in, comms, tmp_ptr,this%north_3d_win)
            ...
            call MPI_WIN_ALLOCATE(win_size*sizeof(realnum), sizeof(realnum), info_in, comms, tmp_ptr, this%south_3d_win)
            ...
            call MPI_WIN_ALLOCATE(win_size*sizeof(realnum), sizeof(realnum), info_in, comms, tmp_ptr, this%east_3d_win)
            call C_F_POINTER(tmp_ptr, this%east_batch_in_3d, [n_3d, nx, nz, ny])
            this%east_batch_in_3d = 1

            call MPI_WIN_ALLOCATE(win_size*sizeof(realnum), sizeof(realnum), info_in, comms, tmp_ptr, this%west_3d_win)
...
module subroutine halo_2d_send_batch(this, exch_vars, adv_vars)
    ...
    if (.not.(this%north_boundary)) then
        ...
        call MPI_Put(this%north_buffer_2d(:,:,:), msg_size, &
            this%NS_2d_win_halo_type, this%north_neighbor, disp, msg_size, this%NS_2d_win_halo_type, this%south_2d_win)
    ...
    if (.not.(this%south_boundary)) then
        ...
        call MPI_Put(this%south_buffer_2d(:,:,:), msg_size, &
            this%NS_2d_win_halo_type, this%south_neighbor, disp, msg_size, this%NS_2d_win_halo_type, this%north_2d_win)
    ...
    if (.not.(this%east_boundary)) then
        ...
        call MPI_Put(this%east_buffer_2d(:,:,:), msg_size, &
            this%EW_2d_win_halo_type, this%east_neighbor, disp, msg_size, this%EW_2d_win_halo_type, this%west_2d_win)
    ...
    if (.not.(this%west_boundary)) then
        ...
        call MPI_Put(this%west_buffer_2d(:,:,:), msg_size, &
            this%EW_2d_win_halo_type, this%west_neighbor, disp, msg_size, this%EW_2d_win_halo_type, this%east_2d_win)
