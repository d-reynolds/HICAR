...
module icar_constants
    ...
    type var_constants_type
        ...
        integer :: sea_surface_pressure = 137
        ...
        integer :: tend_u = 204
        integer :: tend_v = 205
        integer :: tend_th_lwrad = 206
        integer :: tend_th_swrad = 207
        integer :: u_mass = 208
        integer :: v_mass = 209
        integer :: re_cloud = 210
        integer :: re_ice = 211
        integer :: re_snow = 212
        integer :: ice1_rho = 213
        integer :: ice1_phi = 214
        integer :: ice1_vmi = 215
        integer :: ice2_rho = 216
        integer :: ice2_phi = 217
        integer :: ice2_vmi = 218
        integer :: ice3_rho = 219
        integer :: ice3_phi = 220
        integer :: ice3_vmi = 221
        integer :: wind_alpha = 222
        integer :: froude = 223
        integer :: blk_ri = 224
        integer :: out_longwave_rad = 225
        integer :: longwave_cloud_forcing = 226
        integer :: shortwave_cloud_forcing = 227
        integer :: land_emissivity = 228
        integer :: temperature_interface = 229
        integer :: tend_swrad = 230
        integer :: runoff_tstep = 231
        integer :: Tsnow = 232
        integer :: Sice = 233
        integer :: Sliq = 234
        integer :: Ds = 235
        integer :: fsnow = 236
        integer :: Nsnow = 237
        integer :: dSWE_salt = 238
        integer :: dSWE_susp = 239
        integer :: dSWE_subl = 240
        integer :: dSWE_slide = 241
        integer :: meltflux_out_tstep = 242
        integer :: Sliq_out = 243
        integer :: kpbl = 244
        integer :: hpbl = 245
        integer :: lake_depth = 246
        integer :: t_lake3d = 247
        integer :: snl2d = 248
        integer :: t_grnd2d = 249
        integer :: lake_icefrac3d = 250
        integer :: z_lake3d = 251
        integer :: dz_lake3d = 252
        integer :: t_soisno3d = 253
        integer :: h2osoi_ice3d = 254
        integer :: h2osoi_liq3d = 255
        integer :: h2osoi_vol3d = 256
        integer :: z3d = 257
        integer :: dz3d = 258
        integer :: watsat3d = 259
        integer :: csol3d = 260
        integer :: tkmg3d = 261
        integer :: lakemask = 262
        integer :: xice = 263
        integer :: zi3d = 264
        integer :: tksatu3d = 265
        integer :: tkdry3d = 266
        integer :: savedtke12d = 267
        integer :: lakedepth2d = 268
        integer :: ivt = 269
        integer :: iwv = 270
        integer :: iwl = 271
        integer :: iwi = 272
        ! GRID VARIABLES
        integer :: z = 273
        integer :: z_interface = 274
        integer :: dzdx = 275
        integer :: dzdy = 276
        integer :: dz = 277
        integer :: dz_interface = 278
        integer :: advection_dz = 279
        integer :: dzdy_v = 280
        integer :: dzdx_u = 281
        integer :: jacobian = 282
        integer :: jacobian_u = 283
        integer :: jacobian_v = 284
        integer :: jacobian_w = 285
        integer :: land_mask = 286
        integer :: terrain = 287
        integer :: latitude = 288
        integer :: longitude = 289
        integer :: global_terrain = 290
        integer :: global_dz_interface = 291
        integer :: global_z_interface = 292
        integer :: u_latitude = 293
        integer :: u_longitude = 294
        integer :: v_latitude = 295
        integer :: v_longitude = 296
        integer :: Sx = 297
        integer :: TPI = 298
        integer :: neighbor_terrain = 299
        integer :: froude_terrain = 300
        integer :: relax_filter_2d = 301
        integer :: relax_filter_3d = 302
        integer :: costheta = 303
        integer :: sintheta = 304
        integer :: cosine_zenith_angle = 305
        integer :: slope = 306
        integer :: slope_angle = 307
        integer :: aspect_angle = 308
        integer :: svf = 309
        integer :: shd = 310
        integer :: hlm = 311
        integer :: h1 = 312
