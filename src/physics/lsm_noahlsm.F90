...
!   SUBROUTINE)
! ----------------------------------------------------------------------
         ! if (STD_OUT_PE) write(*,*) "       lsm SFLX : SNEQV [m] max:", SNEQV
...
! ----------------------------------------------------------------------
         IF ( (SNOWNG) .OR. (FRZGRA) ) THEN
            ...
            SNEQV = SNEQV + SN_NEW
            PRCPF = 0.0
            ! if (STD_OUT_PE) write(*,*) "         SFLX 520 SN_NEW [m]:", SN_NEW
            ! if (STD_OUT_PE) write(*,*) "         SFLX 520 PRCP [KG M-2 S-1]:", PRCP
            ! if (STD_OUT_PE) write(*,*) "         SFLX 520 DT [s]:", DT
! ----------------------------------------------------------------------
...
! ----------------------------------------------------------------------
         ELSE
            PRCPF = PRCP
         ENDIF
         ! if (STD_OUT_PE) write(*,*) "         SFLX 536 SNEQV [m]:", SNEQV
! ----------------------------------------------------------------------
...
!                          SFHEAD1RT,INFXS1RT,ETPND1)
         ...
         END IF
         ! if (STD_OUT_PE) write(*,*) "       SFLX 774: SNEQV [m]:", SNEQV
